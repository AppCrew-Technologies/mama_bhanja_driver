...
import 'package:mamabhanja_driver/widget/geoflutterfire/src/geoflutterfire.dart';
...
class _AddDriverScreenState extends State<AddDriverScreen> {
  ...
  getDriver() {
    ...
    if (widget.driverDetails != null) {
      ...
      setState(() {
        ...
        carProofPictureURL = widget.driverDetails!.carProofPictureURL;
        driverProofPictureURL = widget.driverDetails!.driverProofPictureURL;
        carPictureURL = widget.driverDetails!.carPictureURL;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildTextFormField(
                        ...
                        // isEnable: widget.driverDetails == null ? true : false
                        readOnly: widget.driverDetails == null ? false : true,
                      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: buildTextFormField(title: "Passengers".tr(), controller: noOfPassengersController, textInputType: TextInputType.number, validator: validateEmptyField),
                          ),
                          const SizedBox(
                            width: 20,
                          ),
  ...
  buildTextFormField({required String title, TextInputType textInputType = TextInputType.text, validator, isEnable = true, readOnly = false, required TextEditingController controller}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
            ...
            if (_key.currentState?.validate() ?? false) {
              ...
              if (widget.driverDetails != null) {
                ...
                User user = User(
                    ...
                    lastName: widget.driverDetails!.lastName,
                    ...
                    createdAt: widget.driverDetails!.createdAt,
                    location: UserLocation(latitude: widget.driverDetails!.location.latitude, longitude: widget.driverDetails!.location.longitude),
                    geoFireData: GeoFireData(
                        geohash: Geoflutterfire().point(latitude: widget.driverDetails!.location.latitude.toDouble(), longitude: widget.driverDetails!.location.longitude.toDouble()).hash,
                        geoPoint: GeoPoint(widget.driverDetails!.location.latitude.toDouble(), widget.driverDetails!.location.longitude.toDouble())));
                ...
                auth.UserCredential result = await auth.FirebaseAuth.instanceFor(app: secondaryApp).createUserWithEmailAndPassword(email: dEmailController.text, password: dPasswordController.text);
