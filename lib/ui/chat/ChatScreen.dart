...
// import 'package:mamabhanja_driver/model/ChatModel.dart';
// import 'package:mamabhanja_driver/model/ChatVideoContainer.dart';
// import 'package:mamabhanja_driver/model/ConversationModel.dart';
// import 'package:mamabhanja_driver/model/HomeConversationModel.dart';
// import 'package:mamabhanja_driver/model/MessageData.dart';
...
// import 'package:mamabhanja_driver/ui/chat/PlayerWidget.dart';
// import 'package:mamabhanja_driver/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
// import 'package:mamabhanja_driver/ui/fullScreenVideoViewer/FullScreenVideoViewer.dart';
...
//                     height: 8,
//                     decoration: BoxDecoration(
//                         color: homeConversationModel.members.firstWhere((element) => element.userID == messageData.senderID).isActive ? Colors.green : Colors.grey,
...
//             child: Container(
//               decoration: BoxDecoration(
//                   color: isDarkMode(context) ? Colors.grey.shade600 : Colors.grey.shade300, shape: BoxShape.rectangle, borderRadius: BorderRadius.all(Radius.circular(8))),
//               child: Padding(
//                 padding: const EdgeInsets.all(4.0),
//                 child: Stack(clipBehavior: Clip.hardEdge, alignment: Alignment.center, children: <Widget>[
//                   Padding(
...
//             } else {
//               _showAlertDialog(context, 'Block'.tr(), "Couldn't block {}".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             }
//           },
//         ),
//         CupertinoActionSheetAction(
