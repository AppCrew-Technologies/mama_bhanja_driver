...
import 'package:mamabhanja_driver/Parcel_service/parcel_order_model.dart';
import 'package:mamabhanja_driver/constants.dart';
import 'package:mamabhanja_driver/main.dart';
import 'package:mamabhanja_driver/model/BlockUserModel.dart';
import 'package:mamabhanja_driver/model/CabOrderModel.dart';
import 'package:mamabhanja_driver/model/CarMakes.dart';
import 'package:mamabhanja_driver/model/CarModel.dart';
import 'package:mamabhanja_driver/model/ChatVideoContainer.dart';
import 'package:mamabhanja_driver/model/CurrencyModel.dart';
import 'package:mamabhanja_driver/model/DeliveryChargeModel.dart';
import 'package:mamabhanja_driver/model/FlutterWaveSettingDataModel.dart';
import 'package:mamabhanja_driver/model/MercadoPagoSettingsModel.dart';
import 'package:mamabhanja_driver/model/OrderModel.dart';
import 'package:mamabhanja_driver/model/PayFastSettingData.dart';
import 'package:mamabhanja_driver/model/PayStackSettingsModel.dart';
import 'package:mamabhanja_driver/model/Ratingmodel.dart';
import 'package:mamabhanja_driver/model/SectionModel.dart';
import 'package:mamabhanja_driver/model/User.dart';
import 'package:mamabhanja_driver/model/VehicleType.dart';
import 'package:mamabhanja_driver/model/VendorModel.dart';
import 'package:mamabhanja_driver/model/conversation_model.dart';
import 'package:mamabhanja_driver/model/email_template_model.dart';
import 'package:mamabhanja_driver/model/inbox_model.dart';
import 'package:mamabhanja_driver/model/notification_model.dart';
import 'package:mamabhanja_driver/model/on_boarding_model.dart';
import 'package:mamabhanja_driver/model/payment_model/mid_trans.dart';
import 'package:mamabhanja_driver/model/payment_model/orange_money.dart';
import 'package:mamabhanja_driver/model/payment_model/xendit.dart';
import 'package:mamabhanja_driver/model/paypalSettingData.dart';
import 'package:mamabhanja_driver/model/paytmSettingData.dart';
import 'package:mamabhanja_driver/model/razorpayKeyModel.dart';
import 'package:mamabhanja_driver/model/referral_model.dart';
import 'package:mamabhanja_driver/model/stripeSettingData.dart';
import 'package:mamabhanja_driver/model/withdrawHistoryModel.dart';
import 'package:mamabhanja_driver/model/withdraw_method_model.dart';
import 'package:mamabhanja_driver/rental_service/model/rental_order_model.dart';
import 'package:mamabhanja_driver/services/helper.dart';
import 'package:mamabhanja_driver/ui/reauthScreen/reauth_user_screen.dart';
import 'package:mamabhanja_driver/userPrefrence.dart';
...
class FireStoreUtils {
  ...
  static Future<List<OnBoardingModel>> getOnBoardingList() async {
    ...
    await firestore.collection(ONBoarding).where("type",isEqualTo: "driver").get().then((value) {
  ...
  static Future<List<VehicleType>> getVehicleType(SectionModel? sectionModel) async {
    ...
    QuerySnapshot<Map<String, dynamic>> currencyQuery =
        await firestore.collection(VEHICLETYPE).where('sectionId', isEqualTo: sectionModel.id).where("isActive", isEqualTo: true).get();
  ...
  static Future<List<SectionModel>> getSections() async {
    ...
    QuerySnapshot<Map<String, dynamic>> productsQuery =
        await firestore.collection(SECTION).where("isActive", isEqualTo: true).where('serviceTypeFlag', isEqualTo: "cab-service").get();
...
// if (docSnapshot.exists) {
            ...
            try {
              ...
              await FireStoreUtils.createPaymentId().then((value) async {
                ...
                await FireStoreUtils.topUpWalletAmountRefral(
                    paymentMethod: "Referral Amount", amount: double.parse(sectionModel!.referralAmount.toString()), id: paymentID, userId: referralModel!.referralBy);
              });
            } catch (error) {
              print(error);
              if (error.toString() == "Bad state: field does not exist within the DocumentSnapshotPlatform") {
  ...
  static firebaseSignUpWithEmailAndPassword(String emailAddress, String password, File? image, File? carImage, File? driverProofImage, File? carProofImage, String carName,
      String carPlate, String firstName, String lastName, String mobile, String serviceType) async {
    try {
