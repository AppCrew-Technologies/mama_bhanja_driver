...
import 'package:mamabhanja_driver/model/ProductModel.dart';
import 'package:mamabhanja_driver/model/TaxModel.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    List<ProductModel> products =
        parsedJson.containsKey('products') ? List<ProductModel>.from((parsedJson['products'] as List<dynamic>).map((e) => ProductModel.fromJson(e))).toList() : [].cast<ProductModel>();
