...
import 'package:mamabhanja_driver/Parcel_service/parcel_home_screen.dart';
import 'package:mamabhanja_driver/Parcel_service/parcel_order_screen.dart';
...
import 'package:mamabhanja_driver/ui/Language/language_choose_screen.dart';
import 'package:mamabhanja_driver/ui/auth/AuthScreen.dart';
import 'package:mamabhanja_driver/ui/bank_details/bank_details_Screen.dart';
import 'package:mamabhanja_driver/ui/chat_screen/inbox_screen.dart';
import 'package:mamabhanja_driver/ui/container/ContainerScreen.dart';
import 'package:mamabhanja_driver/ui/privacy_policy/privacy_policy.dart';
import 'package:mamabhanja_driver/ui/profile/ProfileScreen.dart';
import 'package:mamabhanja_driver/ui/termsAndCondition/terms_and_codition.dart';
import 'package:mamabhanja_driver/ui/wallet/walletScreen.dart';
...
class ParcelServiceDashBoard extends StatefulWidget {
  final User user;

  const ParcelServiceDashBoard({Key? key, required this.user}) : super(key: key);

  @override
  State<ParcelServiceDashBoard> createState() => _ParcelServiceDashBoardState();
}

class _ParcelServiceDashBoardState extends State<ParcelServiceDashBoard> {
                              ...
                              children: [
                                ...
                                ListTileTheme(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text('Parcel Orders').tr(),
                                    onTap: () {
                                      Navigator.pop(context);
                                      setState(() {
                                        _drawerSelection = DrawerSelection.Orders;
                                        _appBarTitle = 'Parcel Orders'.tr();
                                        _currentWidget = ParcelOrderScreen();
                                      });
                                    },
                                  ),
                                ),
