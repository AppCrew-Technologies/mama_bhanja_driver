            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text("Parcel Type : ".tr(), style: const TextStyle(color: Colors.grey)),
                      const SizedBox(
                        height: 5,
                      ),
                      Text(orderModel.parcelType.toString(), style: TextStyle(fontSize: 16, color: Colors.black)),
                    ],
                  ),
                ),
                const SizedBox(
                ...
                Row(
                  ...
                  children: [
                    ...
                    buildOtherDetails(title: "Rate".tr(), value: amountShow(amount: orderModel.subTotal!.toString()), color: Color(COLOR_PRIMARY)),
                  ],
                ),
              ],
            ),
